...
class CelebA(VisionDataset):
    ...
    file_list = [
        ...
        ("0B7EVK8r0v71pZjFTYXZWM3FlRnM", "dummy_api_key_redacted_for_git", "img_align_celeba.zip"),
        # ("0B7EVK8r0v71pbWNEUjJKdDQ3dGc","dummy_api_key_redacted_for_git", "img_align_celeba_png.7z"),
        # ("0B7EVK8r0v71peklHb0pGdDl6R28", "dummy_api_key_redacted_for_git", "img_celeba.7z"),
        ("0B7EVK8r0v71pblRyaVFSWGxPY0U", "dummy_api_key_redacted_for_git", "list_attr_celeba.txt"),
        ("1_ee_0u7vcNLOfNLegJRHmolfH5ICW-XS", "dummy_api_key_redacted_for_git", "identity_CelebA.txt"),
        ("0B7EVK8r0v71pbThiMVRxWXZ4dU0", "dummy_api_key_redacted_for_git", "list_bbox_celeba.txt"),
        ("0B7EVK8r0v71pd0FJY3Blby1HUTQ", "dummy_api_key_redacted_for_git", "list_landmarks_align_celeba.txt"),
        # ("0B7EVK8r0v71pTzJIdlJWdHczRlU", "dummy_api_key_redacted_for_git", "list_landmarks_celeba.txt"),
        ("0B7EVK8r0v71pY0NSMzRuSXJEVkk", "dummy_api_key_redacted_for_git", "list_eval_partition.txt"),
    ]
