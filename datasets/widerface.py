...
class WIDERFace(VisionDataset):
    ...
    FILE_LIST = [
        ...
        ("15hGDLhsx8bLgLcIRD5DhYt5iBxnjNF1M", "dummy_api_key_redacted_for_git", "WIDER_train.zip"),
        ("1GUCogbp16PMGa39thoMMeWxp7Rp5oM8Q", "dummy_api_key_redacted_for_git", "WIDER_val.zip"),
        ("1HIfDbVEWKmsYKJZm4lchTBDLW5N7dY5T", "dummy_api_key_redacted_for_git", "WIDER_test.zip"),
    ]
    ANNOTATIONS_FILE = (
