...
class STL10(VisionDataset):
    ...
    train_list = [
        ["train_X.bin", "dummy_api_key_redacted_for_git"],
        ["train_y.bin", "dummy_api_key_redacted_for_git"],
        ["unlabeled_X.bin", "dummy_api_key_redacted_for_git"],
    ]

    test_list = [["test_X.bin", "dummy_api_key_redacted_for_git"], ["test_y.bin", "dummy_api_key_redacted_for_git"]]
