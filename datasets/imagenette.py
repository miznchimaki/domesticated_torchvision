...
class Imagenette(VisionDataset):
    ...
    _ARCHIVES = {
        "full": ("https://s3.amazonaws.com/fast-ai-imageclas/imagenette2.tgz", "dummy_api_key_redacted_for_git"),
        "320px": ("https://s3.amazonaws.com/fast-ai-imageclas/imagenette2-320.tgz", "dummy_api_key_redacted_for_git"),
        "160px": ("https://s3.amazonaws.com/fast-ai-imageclas/imagenette2-160.tgz", "dummy_api_key_redacted_for_git"),
    }
    _WNID_TO_CLASS = {
