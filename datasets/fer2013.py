...
class FER2013(VisionDataset):
    ...
    _RESOURCES = {
        "train": ("train.csv", "dummy_api_key_redacted_for_git"),
        "test": ("test.csv", "dummy_api_key_redacted_for_git"),
        ...
        # ==> test.csv <==
        # pixels
        "fer": ("fer2013.csv", "dummy_api_key_redacted_for_git"),
        "icml": ("icml_face_data.csv", "dummy_api_key_redacted_for_git"),
    }
