...
class _LFW(VisionDataset):
    ...
    file_dict = {
        "original": ("lfw", "lfw.tgz", "dummy_api_key_redacted_for_git"),
        "funneled": ("lfw_funneled", "lfw-funneled.tgz", "dummy_api_key_redacted_for_git"),
        "deepfunneled": ("lfw-deepfunneled", "lfw-deepfunneled.tgz", "dummy_api_key_redacted_for_git"),
    }
    checksums = {
        "pairs.txt": "dummy_api_key_redacted_for_git",
        "pairsDevTest.txt": "dummy_api_key_redacted_for_git",
        "pairsDevTrain.txt": "dummy_api_key_redacted_for_git",
        "people.txt": "dummy_api_key_redacted_for_git",
        "peopleDevTest.txt": "dummy_api_key_redacted_for_git",
        "peopleDevTrain.txt": "dummy_api_key_redacted_for_git",
        "lfw-names.txt": "dummy_api_key_redacted_for_git",
    }
