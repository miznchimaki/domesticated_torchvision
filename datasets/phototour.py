...
class PhotoTour(VisionDataset):
    ...
    urls = {
        ...
        "yosemite": ["http://icvl.ee.ic.ac.uk/vbalnt/yosemite.zip", "yosemite.zip", "dummy_api_key_redacted_for_git"],
        "liberty": ["http://icvl.ee.ic.ac.uk/vbalnt/liberty.zip", "liberty.zip", "dummy_api_key_redacted_for_git"],
    }
    means = {
        "notredame": 0.4854,
        "yosemite": 0.4844,
