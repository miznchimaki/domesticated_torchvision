...
class OxfordIIITPet(VisionDataset):
    ...
    _RESOURCES = (
        ("https://www.robots.ox.ac.uk/~vgg/data/pets/data/images.tar.gz", "dummy_api_key_redacted_for_git"),
        ("https://www.robots.ox.ac.uk/~vgg/data/pets/data/annotations.tar.gz", "dummy_api_key_redacted_for_git"),
    )
