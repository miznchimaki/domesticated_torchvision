...
class Places365(VisionDataset):
    ...
    # {variant: (archive, md5)}
    _DEVKIT_META = {
        "standard": ("filelist_places365-standard.tar", "dummy_api_key_redacted_for_git"),
        "challenge": ("filelist_places365-challenge.tar", "dummy_api_key_redacted_for_git"),
    }
    # (file, md5)
    _CATEGORIES_META = ("categories_places365.txt", "dummy_api_key_redacted_for_git")
    # {split: (file, md5)}
    _FILE_LIST_META = {
        "train-standard": ("places365_train_standard.txt", "dummy_api_key_redacted_for_git"),
        "train-challenge": ("places365_train_challenge.txt", "dummy_api_key_redacted_for_git"),
        "val": ("places365_val.txt", "dummy_api_key_redacted_for_git"),
        "test": ("places365_test.txt", "dummy_api_key_redacted_for_git"),
    }
    # {(split, small): (file, md5)}
    _IMAGES_META = {
        ("train-standard", False): ("train_large_places365standard.tar", "dummy_api_key_redacted_for_git"),
        ("train-challenge", False): ("train_large_places365challenge.tar", "dummy_api_key_redacted_for_git"),
        ("val", False): ("val_large.tar", "dummy_api_key_redacted_for_git"),
        ("test", False): ("test_large.tar", "dummy_api_key_redacted_for_git"),
        ("train-standard", True): ("train_256_places365standard.tar", "dummy_api_key_redacted_for_git"),
        ("train-challenge", True): ("train_256_places365challenge.tar", "dummy_api_key_redacted_for_git"),
        ("val", True): ("val_256.tar", "dummy_api_key_redacted_for_git"),
        ("test", True): ("test_256.tar", "dummy_api_key_redacted_for_git"),
    }
